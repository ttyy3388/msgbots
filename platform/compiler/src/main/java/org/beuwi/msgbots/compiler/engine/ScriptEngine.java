...
import org.beuwi.msgbots.base.manager.ProjectManager;
...
public class ScriptEngine {
	...
	protected static void run(List<Project> list, String message, String room, String sender, boolean isGroupChat, ImageDB imageDB, String packageName) {
		for (Project project : list) {
			...
			callResponder(project, message,  room, sender, isGroupChat, imageDB, packageName);
		}
	}
	...
	protected static void callResponder(Project project, String message, String room, String sender, Boolean isGroupChat, ImageDB imageDB, String packageName) {
		...
		try {
			...
			if (responder != null) {
				responder.call(context, scope, scope, new Object[] { room, message, sender, isGroupChat, new Replier(project), imageDB, packageName });
			}
