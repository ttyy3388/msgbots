...
public class ContextMenuBase extends javafx.scene.control.ContextMenu implements Control {
    ...
    public void addItem(MenuItem item) { getItems().add(item); }
    public void addItem(int index, MenuItem item) { getItems().add(index, item); }
    public void addItems(MenuItem... items) { getItems().addAll(items); }
    public void addItems(Collection<? extends MenuItem> items) { getItems().addAll(items); }
    public void setItem(int index, MenuItem item) { getItems().set(index, item); }
    public void setItems(MenuItem... items) { getItems().setAll(items); }
    public void setItems(Collection<? extends MenuItem> items) { getItems().setAll(items); }
    public void initItems(MenuItem... items) { getItems().setAll(items); }
}
