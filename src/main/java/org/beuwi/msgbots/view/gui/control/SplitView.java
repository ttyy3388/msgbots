...
import org.beuwi.msgbots.view.gui.control.base.SplitViewBase;
import org.beuwi.msgbots.view.gui.skin.SplitViewSkin;

// 원래 SplitPane은 다중 분할을 위해 만들어 졌으나,
// Intellij Splitter처럼 left, right 두개의 노드를 위한 Pane로 개조함
// 따라서 Divider는 1개만 존재함
public class SplitView extends SplitViewBase {
	public SplitView() {
	}
