package org.beuwi.msgbots.program.gui.editor;
...
class Monaco extends WebPane {
					...
					while (!jsdone.get()) {
						...
						Platform.runLater(() -> {
							...
							if (object instanceof JSObject) {
								...
								execute("editor.updateOptions({minimap:{enabled:" + isMinimapEnabled() + "}})");
	...
	public BooleanProperty minimapEnabledProperty() {
