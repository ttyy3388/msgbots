...
import org.beuwi.msgbots.program.gui.skin.SplitPaneSkin;
...
public class SplitPane extends javafx.scene.control.SplitPane {
	...
	// 지정한 사이드(왼쪽, 오른쪽) 노드가 일정 비율 이하가 되면 토글 되도록
	private final BooleanProperty showDividerProperty = new SimpleBooleanProperty(true);
	public boolean isShowDivider() {
		return showDividerProperty.get();
	}
	public void setShowDivider(boolean value) {
		showDividerProperty.set(value);
	}
	public final BooleanProperty showDividerProperty() {
		return showDividerProperty;
	}
