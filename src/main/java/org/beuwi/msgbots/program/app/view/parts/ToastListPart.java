...
import org.beuwi.msgbots.program.gui.layout.AnchorPane;
import org.beuwi.msgbots.program.utils.AllSVGIcons;

public class ToastListPart extends AnchorPane implements View {
	private static ToastListPart instance = null;
	...
	public ToastListPart() {
		loader = new FormLoader();
		loader.setName("toast-list-part");
		loader.setRoot(this);
	...
	public static ToastListPart getInstance() {
		if (instance == null) {
			instance = new ToastListPart();
		}
		return instance;
	}
}
