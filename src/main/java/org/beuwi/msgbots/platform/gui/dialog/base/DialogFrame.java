...
import org.beuwi.msgbots.platform.gui.window.WindowWrapper;
...
abstract class DialogFrame extends WindowWrapper {
	...
	// 다이얼로그가 생성될 때 동작함
	// private EventHandler<ActionEvent> onCreateHandler;
	// 다이얼로그가 초기화될 때 동작함
	...
	/* public void setOnCreate(EventHandler<ActionEvent> handler) {
	...
	/*
	 * 함수에서 root.setContent(content)...로 안하고 this.content = content로 하고
