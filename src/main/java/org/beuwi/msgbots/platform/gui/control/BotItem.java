...
import org.beuwi.msgbots.action.OpenDesktopAction;
import org.beuwi.msgbots.manager.DebugManager;
import org.beuwi.msgbots.openapi.Project;
import org.beuwi.msgbots.openapi.FormLoader;
import org.beuwi.msgbots.platform.app.view.actions.AddMainAreaTabAction;
import org.beuwi.msgbots.platform.app.view.actions.OpenDebugTabAction;
	...
	public BotItem(Project project) {
		...
		new ContextMenu(
			StdActions.COMPILE.handler(event -> {
				DebugManager.initScript(project, true, false);
			}).toMenuItem(),
