...
public class AllSVGIcons {
	...
	private final static class Glyphs extends HashMap<String, SVGGlyph> {{
		...
		put("Tab.Close", new SVGGlyph("M12.3,13L8,8.7L3.7,13L3,12.3L7.3,8L3,3.7L3.7,3L8,7.3L12.3,3L13,3.7L8.7,8l4.3,4.3L12.3,13z", Color.valueOf("#8C8C8C"), 8, 8));
		...
		put("Bot.Reload", new SVGGlyph("M12.2,3.8C11.1,2.7,9.7,2,8,2C4.7,2,2,4.7,2,8s2.7,6,6,6c2.8,0,5.1-1.9,5.8-5.1h-1.6c-0.6,2.4-2.3,3.6-4.2,3.6c-2.5,0-4.5-2-4.5-4.5s2-4.5,4.5-4.5c1.2,0,2.4,0.5,3.2,1.3L8.7,7.1H14V2L12.2,3.8z", Color.valueOf("#8C8C8C"), 15, 15));
