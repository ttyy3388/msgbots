...
{
	final private static IMenuItem SHOW_COMPILED_CHECK_ITEM = new IMenuItem("Show Compiled Check");
	final private static IMenuItem SHOW_COMPILE_BUTTON_ITEM = new IMenuItem("Show Compile Button");
	final private static IMenuItem SHOW_POWER_SWITCH_ITEM   = new IMenuItem("Show Power Switch");
